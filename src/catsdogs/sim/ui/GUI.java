...
import catsdogs.sim.GameListener;
...
//		boardScroller.getViewport().add(boardPanel);
		...
		setTitle("CIS 700 Summer 2013 - Cats & Dogs " + VERSION);
		setName("GUI");
		...
		boardFrame = new BoardFrame(engine);
	}
